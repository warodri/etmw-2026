...
export declare const AstAndOperatorNodeOutputChildrenItem: core.serialization.Schema<serializers.AstAndOperatorNodeOutputChildrenItem.Raw, ElevenLabs.AstAndOperatorNodeOutputChildrenItem>;
export declare namespace AstAndOperatorNodeOutputChildrenItem {
    type Raw = AstAndOperatorNodeOutputChildrenItem.AndOperator | AstAndOperatorNodeOutputChildrenItem.BooleanLiteral | AstAndOperatorNodeOutputChildrenItem.DynamicVariable | AstAndOperatorNodeOutputChildrenItem.EqOperator | AstAndOperatorNodeOutputChildrenItem.GtOperator | AstAndOperatorNodeOutputChildrenItem.GteOperator | AstAndOperatorNodeOutputChildrenItem.Llm | AstAndOperatorNodeOutputChildrenItem.LtOperator | AstAndOperatorNodeOutputChildrenItem.LteOperator | AstAndOperatorNodeOutputChildrenItem.NeqOperator | AstAndOperatorNodeOutputChildrenItem.NumberLiteral | AstAndOperatorNodeOutputChildrenItem.OrOperator | AstAndOperatorNodeOutputChildrenItem.StringLiteral;
