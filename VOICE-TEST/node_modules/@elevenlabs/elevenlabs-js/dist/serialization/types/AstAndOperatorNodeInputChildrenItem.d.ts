...
export declare const AstAndOperatorNodeInputChildrenItem: core.serialization.Schema<serializers.AstAndOperatorNodeInputChildrenItem.Raw, ElevenLabs.AstAndOperatorNodeInputChildrenItem>;
export declare namespace AstAndOperatorNodeInputChildrenItem {
    type Raw = AstAndOperatorNodeInputChildrenItem.AndOperator | AstAndOperatorNodeInputChildrenItem.BooleanLiteral | AstAndOperatorNodeInputChildrenItem.DynamicVariable | AstAndOperatorNodeInputChildrenItem.EqOperator | AstAndOperatorNodeInputChildrenItem.GtOperator | AstAndOperatorNodeInputChildrenItem.GteOperator | AstAndOperatorNodeInputChildrenItem.Llm | AstAndOperatorNodeInputChildrenItem.LtOperator | AstAndOperatorNodeInputChildrenItem.LteOperator | AstAndOperatorNodeInputChildrenItem.NeqOperator | AstAndOperatorNodeInputChildrenItem.NumberLiteral | AstAndOperatorNodeInputChildrenItem.OrOperator | AstAndOperatorNodeInputChildrenItem.StringLiteral;
