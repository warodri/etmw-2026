...
const AllowlistItem_1 = require("./AllowlistItem");
...
exports.WidgetConfigResponse = core.serialization.object({
    ...
    markdownLinkAllowedHosts: core.serialization.property("markdown_link_allowed_hosts", core.serialization.list(AllowlistItem_1.AllowlistItem).optional()),
    markdownLinkIncludeWww: core.serialization.property("markdown_link_include_www", core.serialization.boolean().optional()),
    markdownLinkAllowHttp: core.serialization.property("markdown_link_allow_http", core.serialization.boolean().optional()),
    ...
    conversationModeToggleEnabled: core.serialization.property("conversation_mode_toggle_enabled", core.serialization.boolean().optional()),
