...
export declare const AstEqualsOperatorNodeInputRight: core.serialization.Schema<serializers.AstEqualsOperatorNodeInputRight.Raw, ElevenLabs.AstEqualsOperatorNodeInputRight>;
export declare namespace AstEqualsOperatorNodeInputRight {
    type Raw = AstEqualsOperatorNodeInputRight.AndOperator | AstEqualsOperatorNodeInputRight.BooleanLiteral | AstEqualsOperatorNodeInputRight.DynamicVariable | AstEqualsOperatorNodeInputRight.EqOperator | AstEqualsOperatorNodeInputRight.GtOperator | AstEqualsOperatorNodeInputRight.GteOperator | AstEqualsOperatorNodeInputRight.Llm | AstEqualsOperatorNodeInputRight.LtOperator | AstEqualsOperatorNodeInputRight.LteOperator | AstEqualsOperatorNodeInputRight.NeqOperator | AstEqualsOperatorNodeInputRight.NumberLiteral | AstEqualsOperatorNodeInputRight.OrOperator | AstEqualsOperatorNodeInputRight.StringLiteral;
