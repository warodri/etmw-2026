...
class WidgetClient {
    ...
    get avatar() {
        var _a;
        return ((_a = this._avatar) !== null && _a !== void 0 ? _a : (this._avatar = new Client_1.AvatarClient(this._options)));
    }
    /**
    ...
    __get(agent_id_1) {
        return __awaiter(this, arguments, void 0, function* (agent_id, request = {}, requestOptions) {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/v1/convai/agents/{agent_id}/widget");
        });
    }
}
