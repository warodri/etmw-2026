...
class VerificationClient {
    ...
    get captcha() {
        var _a;
        return ((_a = this._captcha) !== null && _a !== void 0 ? _a : (this._captcha = new Client_1.CaptchaClient(this._options)));
    }
    /**
    ...
    __request(voice_id, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v1/voices/pvc/{voice_id}/verification");
        });
    }
}
