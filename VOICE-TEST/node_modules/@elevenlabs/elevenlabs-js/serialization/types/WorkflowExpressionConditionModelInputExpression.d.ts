...
export declare const WorkflowExpressionConditionModelInputExpression: core.serialization.Schema<serializers.WorkflowExpressionConditionModelInputExpression.Raw, ElevenLabs.WorkflowExpressionConditionModelInputExpression>;
export declare namespace WorkflowExpressionConditionModelInputExpression {
    type Raw = WorkflowExpressionConditionModelInputExpression.AndOperator | WorkflowExpressionConditionModelInputExpression.BooleanLiteral | WorkflowExpressionConditionModelInputExpression.DynamicVariable | WorkflowExpressionConditionModelInputExpression.EqOperator | WorkflowExpressionConditionModelInputExpression.GtOperator | WorkflowExpressionConditionModelInputExpression.GteOperator | WorkflowExpressionConditionModelInputExpression.Llm | WorkflowExpressionConditionModelInputExpression.LtOperator | WorkflowExpressionConditionModelInputExpression.LteOperator | WorkflowExpressionConditionModelInputExpression.NeqOperator | WorkflowExpressionConditionModelInputExpression.NumberLiteral | WorkflowExpressionConditionModelInputExpression.OrOperator | WorkflowExpressionConditionModelInputExpression.StringLiteral;
