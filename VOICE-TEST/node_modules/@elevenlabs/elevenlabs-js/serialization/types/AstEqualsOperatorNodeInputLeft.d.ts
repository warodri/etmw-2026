...
export declare const AstEqualsOperatorNodeInputLeft: core.serialization.Schema<serializers.AstEqualsOperatorNodeInputLeft.Raw, ElevenLabs.AstEqualsOperatorNodeInputLeft>;
export declare namespace AstEqualsOperatorNodeInputLeft {
    type Raw = AstEqualsOperatorNodeInputLeft.AndOperator | AstEqualsOperatorNodeInputLeft.BooleanLiteral | AstEqualsOperatorNodeInputLeft.DynamicVariable | AstEqualsOperatorNodeInputLeft.EqOperator | AstEqualsOperatorNodeInputLeft.GtOperator | AstEqualsOperatorNodeInputLeft.GteOperator | AstEqualsOperatorNodeInputLeft.Llm | AstEqualsOperatorNodeInputLeft.LtOperator | AstEqualsOperatorNodeInputLeft.LteOperator | AstEqualsOperatorNodeInputLeft.NeqOperator | AstEqualsOperatorNodeInputLeft.NumberLiteral | AstEqualsOperatorNodeInputLeft.OrOperator | AstEqualsOperatorNodeInputLeft.StringLiteral;
