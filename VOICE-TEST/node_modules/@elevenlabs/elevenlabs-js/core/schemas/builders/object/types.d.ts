import type { BaseSchema, inferParsed, inferRaw, Schema } from "@elevenlabs/elevenlabs-js/core/schemas/Schema";
import type { addQuestionMarksToNullableProperties } from "@elevenlabs/elevenlabs-js/core/schemas/utils/addQuestionMarksToNullableProperties";
import type { ObjectLikeUtils } from "@elevenlabs/elevenlabs-js/core/schemas/builders/object-like";
import type { SchemaUtils } from "@elevenlabs/elevenlabs-js/core/schemas/builders/schema-utils";
import type { Property } from "@elevenlabs/elevenlabs-js/core/schemas/builders/object/property";
