...
class SpeakerClient {
    ...
    get segment() {
        var _a;
        return ((_a = this._segment) !== null && _a !== void 0 ? _a : (this._segment = new Client_1.SegmentClient(this._options)));
    }
    /**
    ...
    __update(dubbing_id_1, speaker_id_1) {
        return __awaiter(this, arguments, void 0, function* (dubbing_id, speaker_id, request = {}, requestOptions) {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "PATCH", "/v1/dubbing/resource/{dubbing_id}/speaker/{speaker_id}");
        });
    }
    /**
     * @param {string} dubbing_id - ID of the dubbing project.
    ...
    __create(dubbing_id_1) {
        return __awaiter(this, arguments, void 0, function* (dubbing_id, request = {}, requestOptions) {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v1/dubbing/resource/{dubbing_id}/speaker");
        });
    }
    /**
    ...
    __findSimilarVoices(dubbing_id, speaker_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/v1/dubbing/resource/{dubbing_id}/speaker/{speaker_id}/similar-voices");
        });
    }
}
exports.SpeakerClient = SpeakerClient;
