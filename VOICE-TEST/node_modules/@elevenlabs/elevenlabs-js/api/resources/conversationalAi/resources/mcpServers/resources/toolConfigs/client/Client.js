...
exports.ToolConfigsClient = void 0;
...
class ToolConfigsClient {
    ...
    __create(mcp_server_id, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v1/convai/mcp-servers/{mcp_server_id}/tool-configs");
        });
    }
    /**
    ...
    __get(mcp_server_id, tool_name, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/v1/convai/mcp-servers/{mcp_server_id}/tool-configs/{tool_name}");
        });
    }
    /**
    ...
    __delete(mcp_server_id, tool_name, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "DELETE", "/v1/convai/mcp-servers/{mcp_server_id}/tool-configs/{tool_name}");
        });
    }
    /**
    ...
    __update(mcp_server_id_1, tool_name_1) {
        return __awaiter(this, arguments, void 0, function* (mcp_server_id, tool_name, request = {}, requestOptions) {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "PATCH", "/v1/convai/mcp-servers/{mcp_server_id}/tool-configs/{tool_name}");
        });
    }
}
exports.ToolConfigsClient = ToolConfigsClient;
