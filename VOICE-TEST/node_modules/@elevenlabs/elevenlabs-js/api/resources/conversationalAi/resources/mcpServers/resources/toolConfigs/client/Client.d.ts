...
export declare class ToolConfigsClient {
     ...
     *     })
     */
    create(mcp_server_id: string, request: ElevenLabs.conversationalAi.mcpServers.McpToolConfigOverrideCreateRequestModel, requestOptions?: ToolConfigsClient.RequestOptions): core.HttpResponsePromise<ElevenLabs.McpServerResponseModel>;
    private __create;
    /**
     ...
     */
    get(mcp_server_id: string, tool_name: string, requestOptions?: ToolConfigsClient.RequestOptions): core.HttpResponsePromise<ElevenLabs.McpToolConfigOverride>;
    private __get;
    /**
     ...
     */
    delete(mcp_server_id: string, tool_name: string, requestOptions?: ToolConfigsClient.RequestOptions): core.HttpResponsePromise<ElevenLabs.McpServerResponseModel>;
    private __delete;
    /**
     ...
     */
    update(mcp_server_id: string, tool_name: string, request?: ElevenLabs.conversationalAi.mcpServers.McpToolConfigOverrideUpdateRequestModel, requestOptions?: ToolConfigsClient.RequestOptions): core.HttpResponsePromise<ElevenLabs.McpServerResponseModel>;
    private __update;
}
