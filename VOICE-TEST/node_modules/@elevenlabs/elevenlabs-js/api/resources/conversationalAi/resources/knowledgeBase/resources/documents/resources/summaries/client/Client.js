...
class SummariesClient {
    ...
    __get() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            if (_response.ok) {
                return {
                    data: serializers.conversationalAi.knowledgeBase.documents.summaries.get.Response.parseOrThrow(_response.body, {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/v1/convai/knowledge-base/summaries");
        });
    }
}
