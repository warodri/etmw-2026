...
export type SystemToolConfigOutputParams = ElevenLabs.SystemToolConfigOutputParams.EndCall | ElevenLabs.SystemToolConfigOutputParams.LanguageDetection | ElevenLabs.SystemToolConfigOutputParams.PlayKeypadTouchTone | ElevenLabs.SystemToolConfigOutputParams.SearchDocumentation | ElevenLabs.SystemToolConfigOutputParams.SkipTurn | ElevenLabs.SystemToolConfigOutputParams.TransferToAgent | ElevenLabs.SystemToolConfigOutputParams.TransferToNumber | ElevenLabs.SystemToolConfigOutputParams.VoicemailDetection;
export declare namespace SystemToolConfigOutputParams {
    ...
    interface SearchDocumentation extends ElevenLabs.SearchDocumentationToolConfigOutput {
