 ...
 */
export type AstEqualsOperatorNodeOutputLeft = ElevenLabs.AstEqualsOperatorNodeOutputLeft.AndOperator | ElevenLabs.AstEqualsOperatorNodeOutputLeft.BooleanLiteral | ElevenLabs.AstEqualsOperatorNodeOutputLeft.DynamicVariable | ElevenLabs.AstEqualsOperatorNodeOutputLeft.EqOperator | ElevenLabs.AstEqualsOperatorNodeOutputLeft.GtOperator | ElevenLabs.AstEqualsOperatorNodeOutputLeft.GteOperator | ElevenLabs.AstEqualsOperatorNodeOutputLeft.Llm | ElevenLabs.AstEqualsOperatorNodeOutputLeft.LtOperator | ElevenLabs.AstEqualsOperatorNodeOutputLeft.LteOperator | ElevenLabs.AstEqualsOperatorNodeOutputLeft.NeqOperator | ElevenLabs.AstEqualsOperatorNodeOutputLeft.NumberLiteral | ElevenLabs.AstEqualsOperatorNodeOutputLeft.OrOperator | ElevenLabs.AstEqualsOperatorNodeOutputLeft.StringLiteral;
